...
async def main_async():
  ...
  if existing_sessions and len(existing_sessions.sessions) > 0:
    ...
    SESSION_ID  = existing_sessions.session[0].id 
    print(f"Counting existing session  : {SESSION_ID}")
  ...
  #crate a runner with the memory agent
  ...
  #=== Part 5 : Interactive Conversation ===
